...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { description: @produto.description, name: @produto.name, status: @produto.status }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { description: @produto.description, name: @produto.name, status: @produto.status }
    assert_redirected_to produto_path(assigns(:produto))
  end
